...
export const useConnectionsStore = create<ConnectionsStoreState>((set, get) => ({
    ...
    refresh: async (force = false) => {
        ...
        refreshPromise = (async () => {
            try {
                const nextState = await mongoViewerService.listConnections();
                set({
    ...
    save: async (input) => {
        ...
        try {
            await mongoViewerService.saveConnection(input);
    ...
    remove: async (connectionId) => {
        ...
        try {
            await mongoViewerService.deleteConnection(connectionId);
            set((state) => ({
    ...
    pickTlsCertificate: async () => {
        ...
        try {
            return await mongoViewerService.pickTlsCertificate();
        } catch (error) {
